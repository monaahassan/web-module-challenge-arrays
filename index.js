...
function getFlavorByIndex(originalFlavors, 0){
...
function removeFlavorByName(array, flavorRemoval){
    for(let i in array)[
        if(array[i].(flavoralRemoval)){
            array.splice(i,1);
        }
 return array
}
console.log(removalFlavorByName(copy(), "Chocolate"))
